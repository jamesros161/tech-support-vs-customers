...
if($user->create()){
    ...
    echo "<div class='alert alert-info'>";
        echo "Successfully registered. You must wait for your new account to be confirmed. Once it  has been confirmed, you may <a href='{$home_url}'>login here</a>.";
    echo "</div>";
...
<form action='register.php' method='post' id='register'>
    ...
    <table class='table table-responsive'>
        ...
        <tr>
            ...
            <td><input type='text' name='contact_number' class='form-control' value="<?php echo isset($_POST['contact_number']) ? htmlspecialchars($_POST['contact_number'], ENT_QUOTES) : "";  ?>" /></td>
        </tr>
...
include_once "template/layout_foot.php";
?>